const en = {
  ...
  leadForm: {
    alertMessage:
      "Leave your contact number or email, and we'll be in touch soon...",
    placeholder: "Contact No. or Email",
  },
  steps: {
    sectionHeading: "How Our Home Care Process Works",
    cardDetailsFallback: "Some contents...",
    cards: [
      {
        key: "connect",
        step: "Step-1",
  ...
  services: {
    sectionHeading: "Home Care Services",
    dividerTitle: "Our Services",
    intro:
      "Choosing the right care service is crucial. Explore our range of care services below, simply tap any card to view detailed information about how we can support you or your loved ones with compassionate personal care, specialist dementia support, or assistance with disabilities.",
    touchIconAlt: "Touch Icon",
    cards: [
      {
        key: "homecare",
        title: "Homecare",
  ...
  about: {
    sectionHeading: "About Cozy Corner Care",
    dividerTitle: "About Us",
    items: [
      {
        key: "company",
        description:
          "At Cozy Corner Care, we believe outstanding homecare begins with compassion and clinical excellence.\n\nFounded and managed by experienced NHS nurses, our mission is to provide personalised, professional, and heartfelt care that enables people to live safely and happily in their own homes. We understand that every person's needs are unique that's why our care plans are tailored, flexible, and centred around dignity, respect, and independence.\n\nWhether it's a few hours of support a week or round-the-clock live-in care, we focus on creating meaningful relationships that promote comfort and wellbeing.",
      },
      {
        key: "angela",
        title: "Angela Kimani - Nominated Individual",
        description:
          "After years working within the NHS, I've seen how the smallest acts of compassion can make the biggest difference. At Cozy Corner Care, we focus on building genuine relationships not just completing tasks. Every visit, every conversation, every smile helps someone feel safe, valued, and cared for in their own home.",
      },
      {
        key: "thu",
        title: "Thu Aung - Registered Manager",
        description:
          "Quality care isn't just about clinical skills it's about empathy, dignity, and consistency. Our team brings both medical knowledge and a human touch to every client we support. We believe in providing the same standard of care we'd want for our own families.",
      },
    ],
  },
  faq: {
    sectionHeading: "Frequently Asked Questions",
    dividerTitle: "Frequently Asked Questions",
    items: [
      {
        key: "faq-1",
  ...
  contact: {
    sectionHeading: "Contact Cozy Corner Care",
  ...
  footer: {
    tagline:
      "Elevating care with innovation and heart. Our approach is deeply personal, shaped by founders who truly understand the importance of compassionate care.",
    copyright: "CCC Design. All rights reserved.",
  ...
  messages: {
    ...
    leadThanks: "Thanks! We'll contact you shortly.",
    leadSendFailed: "Sorry, failed to send. Please try again.",
    copiedEmail: "{email} copied to clipboard!",
    copyEmailFailed: "Failed to copy email.",
  },
  forms: {
    leadMessage: "Contact request from Cozy Corner Care website",
    leadSubject: "CCC Website: contact lead",
    leadSource: "homepage-hero",
  },
  cookieBanner: {
    body:
      "We use essential cookies to make this site work. We don't set analytics or advertising cookies unless you accept. Read our",
